...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.INTERR_NPIANI.setObjectName(_fromUtf8("INTERR_NPIANI"))
        ...
        self.ZZ_MORFOLOGIA_COPERTURAID.setObjectName(_fromUtf8("ZZ_MORFOLOGIA_COPERTURAID"))
        self.gridLayout_5.addWidget(self.ZZ_MORFOLOGIA_COPERTURAID, 3, 2, 1, 4)
        ...
        self.codUvCensita.setObjectName(_fromUtf8("codUvCensita"))
        self.gridLayout_5.addWidget(self.codUvCensita, 0, 2, 1, 4)
        self.FUORITERR_NPIANI = QtGui.QSpinBox(Form)
        self.FUORITERR_NPIANI.setObjectName(_fromUtf8("FUORITERR_NPIANI"))
        ...
        self.gridLayout_5.addWidget(self.SCHEDA_EDIFICIOID, 7, 0, 1, 6)
        ...
        self.MANTO_COPERTURA_UNITA_VOLUMETRICAID.setObjectName(_fromUtf8("MANTO_COPERTURA_UNITA_VOLUMETRICAID"))
        ...
        self.edificioOrdinarioRadio.setObjectName(_fromUtf8("edificioOrdinarioRadio"))
        self.gridLayout.addWidget(self.edificioOrdinarioRadio, 0, 0, 1, 1)
        self.edificioGrandiLuciRadio = QtGui.QRadioButton(self.tab_2)
        self.edificioGrandiLuciRadio.setObjectName(_fromUtf8("edificioGrandiLuciRadio"))
        ...
        self.tipoEdificiStacked.setObjectName(_fromUtf8("tipoEdificiStacked"))
        self.STRUTTURE_ORIZZONTALI_COPERTURA_EDIFICI_ORDINARIID = WdgStruttureOrizzontaliCoperturaEdificiOrdinari()
        self.STRUTTURE_ORIZZONTALI_COPERTURA_EDIFICI_ORDINARIID.setObjectName(_fromUtf8("STRUTTURE_ORIZZONTALI_COPERTURA_EDIFICI_ORDINARIID"))
        ...
        self.STRUTTURE_ORIZZONTALI_COPERTURA_EDIFICI_GRANDI_LUCIID.setObjectName(_fromUtf8("STRUTTURE_ORIZZONTALI_COPERTURA_EDIFICI_GRANDI_LUCIID"))
        ...
        self.gridLayout_5.addWidget(self.tabWidget, 5, 0, 1, 6)
        spacerItem1 = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout_5.addItem(spacerItem1, 6, 2, 1, 1)
        ...
        self.codUvOriginale.setObjectName(_fromUtf8("codUvOriginale"))
        self.gridLayout_5.addWidget(self.codUvOriginale, 1, 2, 1, 4)
        ...
        self.ALTEZZA_VOLUME = QtGui.QDoubleSpinBox(Form)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ALTEZZA_VOLUME.sizePolicy().hasHeightForWidth())
        self.ALTEZZA_VOLUME.setSizePolicy(sizePolicy)
        self.ALTEZZA_VOLUME.setMaximum(500.0)
        self.ALTEZZA_VOLUME.setObjectName(_fromUtf8("ALTEZZA_VOLUME"))
        self.gridLayout_5.addWidget(self.ALTEZZA_VOLUME, 2, 5, 1, 1)
