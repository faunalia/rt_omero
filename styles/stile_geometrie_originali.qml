...
<qgis version="1.7.0-Trunk" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="10000000" description="" filter="" symbol="0" scalemindenom="25000" label=" 1:25k - oltre"/>
      <rule scalemaxdenom="25000" description="" filter="" symbol="1" scalemindenom="2000" label=" 1:2k - 1:25k"/>
      <rule scalemaxdenom="2000" description="" filter="" symbol="2" scalemindenom="1" label=" 1:1 - 1:2k"/>
    </rules>
    <symbols>
